...
function createMenuItem(name, price, category){
    const newObj = {name, price, category};
    return newObj;
}
...
*/
console.log(createMenuItem("Pizza", 20, "Main"));
console.log(createMenuItem("Wings", 13, "Appetizers"));
console.log(createMenuItem("Coors Light Draft", 3.50, "Drinks"));
...
reviews.push({name: "Mike", rating: 3, feedback: "Pizza wasn't great, but the wings were awesome!"});
// console.log(reviews);
